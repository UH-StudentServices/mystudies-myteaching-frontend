  ...
  .factory('DegreeResource', function ($resource, StateService) {
    function resource() {
      return $resource('/api/' + StateService.getCurrent()
        + '/v1/profile/:profileId/degree', {}, { update: { method: 'POST', isArray: true } });
    }

    function updateDegrees(profileId, degrees) {
      return resource().update({ profileId: profileId }, degrees).$promise;
    }
