    ...
    return {
      ...
      focusNext: function () {
        if (currentFocusElement) {
          var focusables = $(focusableQuery).filter(':visible'); // eslint-disable-line vars-on-top
          var index = focusables.index(currentFocusElement); // eslint-disable-line vars-on-top
