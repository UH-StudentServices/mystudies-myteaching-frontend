    ...
    return {
      ...
      link: function (scope) {
        ...
        function isTranslatableHeading() {
          var translatableHeading = scope.headingKey && $translate.instant(scope.headingKey);
          return translatableHeading === scope.freeTextContentItem.title;
        }
